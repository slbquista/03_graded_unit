...
SELECT gyle, container_id, number_of_items, location_id, filled, date_filled, packaged, drink_id FROM gu_batch WHERE (gyle = @gyle)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT gyle, container_id, number_of_items, location_id, filled, date_filled, pac" +
                "kaged, drink_id FROM dbo.gu_batch WHERE filled=\'Y\'";
        ...
        public virtual int FillBy(gu_tables.gu_batchDataTable dataTable) {

namespace Inventory_Management_Project
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.selectGyleBottle.DataSource = this.gubatchBindingSource2;
			...
			this.selectGyleLabel.DataSource = this.gubatchBindingSource5;
			...
			this.dataGridView3.DataSource = this.salesAvailableViewBindingSource2;
